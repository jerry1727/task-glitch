...
import { Box, Button, Card, CardContent, Chip, IconButton, Stack, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Tooltip, Typography } from '@mui/material';
                ...
                <TableRow key={t.id} hover onClick={() => setDetails(t)} sx={{ cursor: 'pointer' }}>
                  ...
                  <TableCell>
                    <Chip
                      ...
                      variant={t.status === 'Todo' ? 'outlined' : 'filled'}
                    />
                  </TableCell>
